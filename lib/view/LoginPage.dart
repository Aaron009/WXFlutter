...
class _LoginPageState extends State<LoginPage> {
                ...
                child: Card(
                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            InputWidget(
                              hintText: appStrings.enterYourAccount,
                            ...
                            RaisedButton(
                              ...
                              child: Flex(
                                ...
                                children: <Widget>[
                                  Expanded(child: Text(appStrings.registered, textAlign: TextAlign.center, style: new TextStyle(fontSize: 20),)),
                                ],
                              ),
                              textColor: Colors.white,
                              onPressed: () {
                            ...
                            InkWell(
                              onTap: () {
                                NavigatorUtils.goView(context, NavigatorUtils.language);
                              },
                              child: Text(
  ...
  void pressLogin() {
      ...
      NavigatorUtils.goView(context, NavigatorUtils.home);
  }

  void pressRegister() {
    print('注册 $_userName  $_password');

    ThemeModel themeMode = Provider.of<ThemeModel>(context);
